          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box">
                ...
                <hr>
               <form action="" method="POST" class="form-horizontal" id="registro" name="registro">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" maxlength="19" placeholder="Nombre" id="nom_usu" class="form-control" ondrop="return false" onpaste="return false" name="nom" onkeypress="return soloLetras(event)" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" maxlength="19" placeholder="Curp" id="Curp_usu" class="form-control" ondrop="return false" onpaste="return false" name="Curp" onkeypress=" return curp(event)" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" maxlength="19" placeholder="Correo" id="Mail_usu" class="form-control" ondrop="return false" onpaste="return false" name="Mail" onkeypress=" return correo(event)" required="">
                        </div>
                    </div>
                   
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="password" maxlength="19" placeholder="Contraseña" id="pass_usu" class="form-control" ondrop="return false" onpaste="return false" name="pass" onkeypress="return contrasena(event)" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" placeholder="Rol" id="Id_Rol" class="form-control" ondrop="return false" maxlength="3" onpaste="return false" name="sala" onkeypress="return validar(event)" required="">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                       ...
                       <p class="text-center">
                            <input type="button" class="btn btn-template-outlined" value="Registrarse" onclick="return registrar()">
                       </p>
                    </div>
                </form>
              </div>
            ...
            <div class="col-lg-6">
              <div class="box">
                ...
                <hr>
                <h4 style="color: #e22b2b;">Parece que escribiste mal tu usuario y/o
                contraseña, por favor inténtalo de nuevo</h4>
                 <form method="POST" action="IniciarSesion" class="form-horizontal" name="iniciar">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" placeholder="Email" id="Email_usu" class="form-control" name="Mail_usu"  ondrop="return false" onpaste="return false" maxlength="19"  required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
