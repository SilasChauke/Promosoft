<%-- 
    Document   : protafolio
    Created on : 5/10/2018, 02:31:49 PM
    Author     : alberto
--%>
       ...
       <div class="row portfolio-project">
              <div class="col-sm-8">
                <div class="project owl-carousel mb-4">
                  <div class="item"><img src="img/men.jpg" alt="" class="img-fluid"></div>
                ...
                <div class="box-image">
                  <div class="image"><img src="img/portfolio-1.jpg" alt="" class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center">
                      <div class="content">
                        <div class="name">
                          <h3><a href="proyecto1.jsp" class="color-white">Proyecto DE ejemplo</a></h3>
                        </div>
                        <div class="text">
