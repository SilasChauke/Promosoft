...
<html>
  ...
  <body>
    <div id="all">
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">ERROR 404 PAGINA NO DISPONIBLE</h1>
            </div>
            <div class="col-md-5">
      ...
      <div align="center">
          <br><br>
          <h1>Lo sentimos, la pagina solicitada no existe o se encuentra fuera de servicio</h1>
          <center><a href="protafolio.jsp" class="btn btn-template-outlined">Regresar</a></center>
      </div>
    </body>
</html>
